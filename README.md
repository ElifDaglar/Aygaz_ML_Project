Online Payments Fraud Detection Dataset, çevrimiçi ödeme dolandırıcılığını tespit etmek amacıyla kullanılan ve genellikle makine öğrenmesi ve veri bilimi uygulamaları için tasarlanmış bir veri setidir. 
